...
export const tr: Dict = {
  ...
  'settings.cliEnvHint':
    'Set non-secret configuration directories for packaged app launches and agent detection.',
  ...
  'settings.cliEnvSpilliKeyPath': 'SpiLLI .pem key path',
  'settings.cliEnvSpilliScope': 'SpiLLI scope',
  'settings.cliEnvSpilliTeam': 'SpiLLI team',
